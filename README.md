...
FreshCollect is a mobile web app developed by 3 Le Wagon students as their final Project. Check out the result here: [FreshCollect](http://www.fresh-collect.xyz). Important! The design is optimised for mobile only. So switch to the mobile view, sign up and let's go! 
<br>
